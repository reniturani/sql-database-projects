...
-- Archivo: inserts.sql
-- Descripción: Carga de datos iniciales en las tablas y asignación de directores a los departamentos
USE empresa; 
INSERT INTO departamentos (codigo, nombre) VALUES (1, 'Recursos Humanos');
INSERT INTO departamentos (codigo, nombre) VALUES (2, 'Sistemas');
INSERT INTO departamentos (codigo, nombre) VALUES (3, 'Finanzas');
INSERT INTO departamentos (codigo, nombre) VALUES (4, 'Administración');
INSERT INTO departamentos (codigo, nombre) VALUES (5, 'Logística');
...
SET dni_director = 100
WHERE codigo = 1;

-- Sistemas
UPDATE departamentos
SET dni_director = 200
WHERE codigo = 2;

-- Finanzas
UPDATE departamentos
SET dni_director = 300
WHERE codigo = 3;